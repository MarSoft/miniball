 ...
 * side-by-side with a list of items in a {@link DanceListActivity}.
 * <p>
...
public class DanceDetailActivity extends SherlockFragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			arguments.putString(DanceDetailFragment.ARG_DANCE_NAME, getIntent()
					.getStringExtra(DanceDetailFragment.ARG_DANCE_NAME));
			DanceDetailFragment fragment = new DanceDetailFragment();
			fragment.setArguments(arguments);
			getSupportFragmentManager().beginTransaction()
					.add(R.id.dance_detail_container, fragment).commit();
		}
	}
